...
const int switch2 = 5;    //switch 2 on pin 5
const int sigA = 1;       // LED pin on 1
const int sigB = 2;       // LED pin on 2
...
for (int i = 0; i<lenth; i++){      //incrementing the pulse by 12 each itteration
